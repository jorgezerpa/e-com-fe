    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-gray-800 w-full max-w-md rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="p-6 border-b border-gray-100 dark:border-gray-700">
          <h2 className="text-xl font-bold">Crear Nueva Tienda</h2>
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Nombre de la Tienda</label>
            <input 
              type="text"
              value={formData.name}
...
export default function CompanySelection() {
  ...
  const handleCreateSave = async (data: CreateCompany) => {
    ...
    try {
      ...
      setModalError('Error al crear la Tienda. Verifica los datos.');
    }
  };
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {loading ? (
          <div className="flex flex-col justify-center items-center h-64 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Cargando Tiendas...</p>
          </div>
        ) : error ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 bg-white dark:bg-gray-800 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-700 text-center">
            ...
            <h3 className="font-bold">No tienes Tiendas aún</h3>
            <p className="text-xs text-gray-500 mt-1 max-w-xs">Crea tu primera Tienda para empezar a vender tus productos.</p>
          </div>
        ) : (
          /* Grid Area */
